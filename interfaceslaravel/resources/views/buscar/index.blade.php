...
<html lang="es">
    <head>
        ...
        <title>PLADDES</title>
        <link rel="stylesheet" href="http://tramite.unsaac.edu.pe/assets/css/bootstrap.min.css" />
<link rel="stylesheet" href="http://tramite.unsaac.edu.pe/assets/css/font-awesome.min.css">
<link rel="stylesheet" href="http://tramite.unsaac.edu.pe/assets/css/ionicons.min.css">
<link rel="stylesheet" href="http://tramite.unsaac.edu.pe/assets/css/AdminLTE.min.css">
<link rel="stylesheet" href="http://tramite.unsaac.edu.pe/assets/css/skins/skin-brown.min.css">
<link rel="stylesheet" href="http://tramite.unsaac.edu.pe/assets/css/dataTables.bootstrap.min.css">
<link rel="stylesheet" href="http://tramite.unsaac.edu.pe/assets/css/vis.css">
<link rel="stylesheet" href="http://tramite.unsaac.edu.pe/assets/css/responsive.dataTables.min.css">
<link rel="stylesheet" href="http://tramite.unsaac.edu.pe/assets/css/chat.css">    </head>
                      ...
                      <li>
                          <ul class="menu">
                            <li>
                              <a href="#">
                                <div class="pull-left">
                                  <img src="http://tramite.unsaac.edu.pe/assets/img/user.jpg" class="img-circle" alt="Invitado">
                                </div>
                                <h4>
                                  Support Team
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="user-footer" style="border: 1px solid #6f1521">
                    <div class="pull-left" style="width:50%;text-align: left;">
                      <a href="http://tramite.unsaac.edu.pe/login/cambiar_pass" class="btn btn-default btn-flat" style="background: #6f1521; color: rgba(255,255,255,0.8);width: 90%;">Cambiar <br>Contraseña</a>
                    </div>
                    <div class="pull-right" style="width:50%;text-align: right;">
                      <a href="http://tramite.unsaac.edu.pe/login/" class="btn btn-default btn-flat" style="background: #6f1521; color: rgba(255,255,255,0.8);width: 90%;">Cerrar <br>Sesión</a>
                    </div>
                  </li>
                </ul>
              </li>
    ...
    <ol class="breadcrumb">
        <li><a href="http://tramite.unsaac.edu.pe/"><i class="fa fa-dashboard"></i> Inicio</a></li>
        <li><a href="http://tramite.unsaac.edu.pe/tramite/?id=1">Tramite Documentario</a></li>
...
-->        </div>
        <div id="modal_Seguimiento" class="modal fade">
        ...
        <script src="http://tramite.unsaac.edu.pe/assets/js/build.js"></script>
<script src="http://tramite.unsaac.edu.pe/assets/js/highcharts.js"></script>
<script src="http://tramite.unsaac.edu.pe/assets/js/dataTables.responsive.min.js"></script>
<script src="http://tramite.unsaac.edu.pe/assets/js/socket.io.js"></script>
<script src="http://tramite.unsaac.edu.pe/assets/js/chat.js"></script>
